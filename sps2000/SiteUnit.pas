...
//          else messagedlg('未能与控制器建立连接!',mterror,[mbok],0);
        ...
        else messagedlg('未能建立连接!'+#13+#10+ss,mterror,[mbok],0);
      end
      else messagedlg('调制解调器未响应!',mterror,[mbok],0);
    end
    else
    begin
